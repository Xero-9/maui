...
{
	public class MonkeyData : IDataStore<MonkeyData>
	{
		public IList<Animal> Animals { get; private set; }
#if ENABLE_DI_CHANGES || USE_PARTIAL_DI
		public ILogger<MonkeyData> Logger { get; }
		public MonkeyData(ILogger<MonkeyData> logger) : this()
		{
			Logger = logger;
		}
#else
		public static MonkeyData Instance { get; } = new MonkeyData();
#endif
		MonkeyData()
		{
