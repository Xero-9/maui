...
{
	public class DogData : IDataStore<DogData>
	{
		public IList<Animal> Animals { get; private set; }
#if ENABLE_DI_CHANGES || USE_PARTIAL_DI
		public ILogger<DogData> Logger { get; }
		public DogData(ILogger<DogData> logger) : this()
		{
			Logger = logger;
		}
#else
		public static DogData Instance { get; } = new DogData();
#endif
		DogData()
		{
