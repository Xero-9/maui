...
{
	public class ElephantData : IDataStore<ElephantData>
	{
		public IList<Animal> Animals { get; private set; }
#if ENABLE_DI_CHANGES || USE_PARTIAL_DI
		public ILogger<ElephantData> Logger { get; }
		public ElephantData(ILogger<ElephantData> logger) : this()
		{
			Logger = logger;
		}
#else
		public static ElephantData Instance { get; } = new ElephantData();
#endif
		public ElephantData()
		{
