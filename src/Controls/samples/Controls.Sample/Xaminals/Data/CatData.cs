...
{
	public class CatData : IDataStore<CatData>
	{
		public IList<Animal> Animals { get; private set; }
#if ENABLE_DI_CHANGES || USE_PARTIAL_DI
		public ILogger<CatData> Logger { get; }
		public CatData(ILogger<CatData> logger) : this()
		{
			Logger = logger;
		}
#else
		public static CatData Instance { get; } = new CatData();
#endif
		CatData()
		{
