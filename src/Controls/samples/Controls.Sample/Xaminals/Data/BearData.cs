...
{
	public class BearData : IDataStore<BearData>
	{
		public IList<Animal> Animals { get; private set; }
#if ENABLE_DI_CHANGES || USE_PARTIAL_DI
		public ILogger<BearData> Logger { get; init; }
		public BearData(ILogger<BearData> logger) : this()
		{
			Logger = logger;
		}
#else
		public static BearData Instance { get; } = new BearData();
#endif
		BearData()
		{
